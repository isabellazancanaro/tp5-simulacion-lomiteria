...
def simular(p: dict) -> dict:
    ...
    # last guarda los números aleatorios y tiempos generados en el último evento.
    # El vector de estado lee estos valores para mostrar de dónde salió cada variable aleatoria.
    # Importante: en la inicialización también se guardan los RND de la primera llegada.
    last: dict = {
        "r1_llg": r1,
        "r2_llg": r2,
        "tel": tel,
    ...
    # Devuelve todo lo que luego se mostrará en las pestañas de Streamlit.
    return {
        "vector": df_vector,
